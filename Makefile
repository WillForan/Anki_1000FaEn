.PHONY all: txt/fa_words_mp3.txt
...
txt/fa_words_forvo.txt: txt/fa_words.txt
	perl -F"\t" -MURI::Encode=uri_encode -slane 'print $$F[1],"\thttps://forvo.com/search/",uri_encode($$F[1]),"/fa"'  txt/fa_words.txt > txt/fa_words_forvo.txt
